...
- Method `Mautic\PluginBundle\Model\IntegrationEntityModel::getRecordList()` removed. It was unused and called `getRecords()`, which `IntegrationObject` does not have.
