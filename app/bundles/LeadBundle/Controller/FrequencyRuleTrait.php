...
trait FrequencyRuleTrait
{
     ...
     */
    protected function getFrequencyRuleForm(\Mautic\LeadBundle\Entity\Lead $lead, &$viewParameters = [], &$data = null, $isPublic = false, $action = null, $isPreferenceCenter = false)
    {
        /** @var LeadModel $model */
