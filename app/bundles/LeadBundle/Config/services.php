...
return function (ContainerConfigurator $configurator): void {
    ...
    $services->set('Mautic\LeadBundle\Form\Validator\Constraints\FieldAliasKeywordValidator', Mautic\LeadBundle\Form\Validator\Constraints\FieldAliasKeywordValidator::class)->tag('validator.constraint_validator');
    $services->set('Mautic\CoreBundle\Form\Validator\Constraints\FileEncodingValidator', Mautic\CoreBundle\Form\Validator\Constraints\FileEncodingValidator::class)->tag('validator.constraint_validator');
