...
class LeadSubscriber implements EventSubscriberInterface
{
    ...
    private function addTimelineIpAddressEntries(Events\LeadTimelineEvent $event, string $eventTypeKey, $eventTypeName): void
    {
        $lead = $event->getLead();
    ...
    private function addTimelineDateCreatedEntry(Events\LeadTimelineEvent $event, string $eventTypeKey, $eventTypeName): void
    {
    ...
    private function addTimelineDateIdentifiedEntry(Events\LeadTimelineEvent $event, string $eventTypeKey, $eventTypeName): void
    {
        // Do nothing if the lead is not set
        if (!$event->getLead() instanceof Lead) {
            return;
    ...
    private function addTimelineUtmEntries(Events\LeadTimelineEvent $event, string $eventTypeKey, $eventTypeName): void
    {
    ...
    private function addTimelineDoNotContactEntries(Events\LeadTimelineEvent $event, string $eventTypeKey, $eventTypeName): void
    {
    ...
    private function addTimelineImportedEntries(Events\LeadTimelineEvent $event, string $eventTypeKey, $eventTypeName): void
    {
    ...
    private function addTimelineApiCreatedEntries(Events\LeadTimelineEvent $event, string $eventTypeKey, $eventTypeName): void
    {
        /** @var LeadEventLogRepository $eventLogRepo */
        $eventLogRepo    = $this->entityManager->getRepository(LeadEventLog::class);
