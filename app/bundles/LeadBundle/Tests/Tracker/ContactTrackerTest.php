...
final class ContactTrackerTest extends \PHPUnit\Framework\TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->securityMock->expects($this->atLeastOnce())->method('isAnonymous')
            ->willReturn(true);
    ...
    public function testSystemContactIsUsedOverTrackedContact(): void
    {
        ...
        $this->leadRepositoryMock->expects($this->atLeastOnce())
    ...
    public function testContactIsTrackedByDevice(): void
    {
        ...
        $this->deviceTrackerMock->expects($this->atLeastOnce())->method('getTrackedDevice')
            ->willReturn($device);
    ...
    public function testEventIsDispatchedWithChangeOfContact(): void
    {
        ...
        $lead2->expects($this->atLeastOnce())->method('getId')
            ->willReturn(2);
