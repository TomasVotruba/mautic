...
class WebhookService
{
    ...
    public function isWebhookHealthy(Webhook $webhook): bool
    {
        ...
        return $webhook->getMarkedUnhealthyAt() === null || ($webhook->getMarkedUnhealthyAt() < $healthyWebhookTime);
    }
    ...
    {
        if ($webhook->getUnHealthySince() === null) {
            return false;
        }
    ...
    {
        if ($webhook->getLastNotificationSentAt() === null) {
            return true;
        }
