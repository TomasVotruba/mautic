...
class AssetExtension extends AbstractExtension
{
    ...
    {
        return [
            new TwigFunction('outputScripts', [$this, 'outputScripts'], [
                'is_safe' => ['all'],
            ]),
            new TwigFunction('includeScript', [$this, 'includeScript'], [
                'is_safe' => ['all'],
            ]),
            new TwigFunction('includeStylesheet', [$this, 'includeStylesheet'], [
                'is_safe' => ['all'],
            ]),
            new TwigFunction('outputHeadDeclarations', [$this, 'outputHeadDeclarations'], [
                'is_safe' => ['all'],
            ]),
            new TwigFunction('getAssetUrl', [$this, 'getAssetUrl'], [
                'is_safe' => ['html'],
            ]),
            new TwigFunction('getOverridableUrl', [$this, 'getOverridableUrl'], [
                'is_safe' => ['html'],
            ]),
            new TwigFunction('addAssetScript', [$this, 'addScript'], [
                'is_safe' => ['html'],
            ]),
            new TwigFunction('outputStyles', [$this, 'outputStyles'], [
                'is_safe' => ['html'],
            ]),
            new TwigFunction('outputSystemScripts', [$this, 'outputSystemScripts'], [
                'is_safe' => ['html'],
            ]),
            new TwigFunction('outputSystemStylesheets', [$this, 'outputSystemStylesheets'], [
                'is_safe' => ['html'],
            ]),
            ...
            new TwigFunction('assetGetBaseUrl', [$this, 'getBaseUrl'], [
                'is_safe' => ['html'],
            ]),
            new TwigFunction('assetMakeLinks', [$this, 'makeLinks'], [
                'is_safe' => ['html'],
            ]),
        ];
    }
