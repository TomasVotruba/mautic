...
class FormatterExtension extends AbstractExtension
{
    ...
    {
        return [
            new TwigFilter('formatter_simple_array_to_html', [$this, 'simpleArrayToHtml'], [
                'is_safe' => ['html'],
            ]),
        ];
    }
    ...
    {
        return [
            new TwigFunction('format', [$this, '_'], [
                'is_safe' => ['all'],
            ]),
            new TwigFunction('normalizeStringValue', [$this, 'normalizeStringValue']),
            new TwigFunction('formatter_simple_array_to_html', [$this, 'simpleArrayToHtml'], [
                'is_safe' => ['html'],
            ]),
        ];
    }
