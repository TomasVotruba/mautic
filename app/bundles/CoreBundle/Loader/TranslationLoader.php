...
class TranslationLoader extends ArrayLoader implements LoaderInterface
{
     ...
     * @throws \Exception
     */
    private function loadTranslations(\Symfony\Component\Translation\MessageCatalogue $catalogue, string $locale, \Symfony\Component\Finder\SplFileInfo $file): void
    {
