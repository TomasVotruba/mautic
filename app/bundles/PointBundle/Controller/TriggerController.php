...
class TriggerController extends FormController
{
    ...
    public function indexAction(Request $request, PageHelperFactoryInterface $pageHelperFactory, $page = 1): Response
    {
        ...
        if ($count && $count < ($start + 1)) {
            ...
            $returnUrl = $this->generateUrl('mautic_pointtrigger_index', [
                'page' => $lastPage,
            ]);
        ...
        return $this->delegateView([
            ...
            'passthroughVars' => [
                'activeLink'    => '#mautic_pointtrigger_index',
                'mauticContent' => 'pointTrigger',
                'route'         => $this->generateUrl('mautic_pointtrigger_index', [
                    'page' => $page,
                ]),
            ],
        ]);
    ...
    public function newAction(Request $request, ?Trigger $entity = null, array $triggerEvents = []): Response
    {
        ...
        $action = $this->generateUrl('mautic_pointtrigger_action', [
            'objectAction' => 'new',
        ]);
