...
final class Version20250618122722 extends PreUpAssertionMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $table->addColumn('dynamic_content_id', 'integer', ['unsigned' => $targetIdDataType === 'UNSIGNED', 'notnull' => true]);
        $table->addColumn('project_id', 'integer', ['unsigned' => $projectIdDataType === 'UNSIGNED', 'notnull' => true]);
